    ...
    <div className="fixed bottom-6 left-6 right-6 z-50">
      <div className="bg-slate-900/80 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] shadow-2xl p-2 flex items-center justify-between relative px-4 text-gray-400">
        ...
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-gradient-to-br from-secondaryCyan to-primaryTeal text-white shadow-lg shadow-teal-500/30 flex items-center justify-center transform hover:scale-105 transition-all"
        >
