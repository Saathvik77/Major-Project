    ...
    <div className="glass-card w-full max-w-full overflow-hidden p-5 sm:p-6 md:p-8 flex flex-col flex-1 border border-white/5 bg-white/[0.02] relative group">
      ...
      {steps ? (
        ...
        <div className="flex flex-col sm:flex-row gap-2 mt-auto w-full">
          ...
          />
          <button onClick={logSteps} className="px-4 py-2 bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 font-black rounded-xl hover:bg-yellow-500/40 uppercase tracking-wide shrink-0 whitespace-nowrap">Log</button>
        </div>
      )}
    </div>
  );
