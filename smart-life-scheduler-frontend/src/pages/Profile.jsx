...
import { User, Mail, Phone, Calendar, Dumbbell, Activity, LogOut, ChevronLeft, Check, Camera, Shield, BadgeCheck, Palette, Sun, Moon, Waves, Zap, Flame } from "lucide-react";
...
export default function Profile() {
  ...
  const themes = [
    { id: 'auto', name: 'Time-Based Auto', icon: <Activity size={16} /> },
    { id: 'default', name: 'Dark Blue', icon: <Moon size={16} /> },
    { id: 'cyberpunk', name: 'Cyberpunk', icon: <Zap size={16} /> },
    { id: 'ocean', name: 'Ocean', icon: <Waves size={16} /> },
    { id: 'sunset', name: 'Sunset', icon: <Flame size={16} /> },
    { id: 'neon', name: 'Neon', icon: <Palette size={16} /> },
    { id: 'light', name: 'Light Mode', icon: <Sun size={16} /> }
  ];
