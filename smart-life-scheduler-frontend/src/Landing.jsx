      ...
      <section className="flex flex-col items-center justify-center text-center mt-28 px-6 animate-fadeIn">
        ...
        <div className="relative group">
          ...
          <button 
            ...
            className="relative bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-400 hover:-translate-y-1 hover:scale-105 transform transition duration-300 shadow-2xl hover:shadow-purple-500/50 px-8 py-3 rounded-xl text-lg font-semibold">
            Get Started
          </button>
        </div>
